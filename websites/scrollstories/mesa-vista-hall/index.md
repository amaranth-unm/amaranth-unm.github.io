...
This page is generated by a single text file that you can edit on GitHub or in any text editor. Headings, image placement, and background images are all controlled by small commands you put in the text. **There is no code!**
...
If you have lots of fun images but can't really work them into your essay, you can display them in a compact carousel. You can control the size and add captions to the images as well, although this one is just the plain photos from the University Archives.
