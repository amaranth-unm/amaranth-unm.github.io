...
header-title: "The medium is part of the argument"
---
...
<p class="text-end mt-3"><a href="/websites/scrollstories" class="btn btn-primary">Explore ScrollStories →</a></p>
...
<p class="text-end mt-3"><a href="/narrate/oral-histories" class="btn btn-primary">Learn about oral histories →</a></p>
...
<p class="text-end mt-3"><a href="/narrate/podcasting" class="btn btn-primary">Start podcasting →</a></p>


## Getting started with audio

You don't need professional equipment or experience. A phone and a quiet room get you surprisingly far, and the [YETI mics](/equipment/yeti-mics) in the studio are available for higher-quality recording. We have guides for [recording audio](/narrate/recording) and [editing with Audacity](/narrate/audacity)---a free, open-source editor that's more than capable for humanities audio work.
