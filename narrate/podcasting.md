...
header-image: /assets/images/headers/bells.jpg
header-tier: section
header-filter: photo
...
You don't need professional equipment. A phone and a quiet room work for a first episode. For higher quality, the [YETI mics](/equipment/yeti-mics) in the studio are available, and our guides for [recording audio](recording) and [editing with Audacity](audacity) cover the technical side. The harder part---finding your voice, shaping a story, deciding what matters---is what we're here to help with.
