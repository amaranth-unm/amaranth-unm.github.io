...
{% include figure.html
  class="center"
  width="100%"
  caption="Student posters from Amaranth courses. Notice how each uses different visual strategies---dominant images, bold typography, color palettes---to draw you in."
  image-path="/assets/images/site/four-posters.jpg"
%}


<p style="text-align: right"><a href="/craft/poster-design" class="btn-cta">Design your poster →</a></p>
