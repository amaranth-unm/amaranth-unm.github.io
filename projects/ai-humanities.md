...
author: Fred Gibbs
date: 2026-09-10
description: "How AI can deepen humanities research at UNM, from exploring archival collections to making oral histories searchable. Amaranth works with faculty and students from first question through public output."
header-image: /assets/images/headers/eniac-programmers.jpg
header-title: AI for Humanities Research
header-tier: section
header-filter: photo
header-caption: Glen Beck and Betty Snyder program the ENIAC at the Ballistic Research Laboratory
---
...
**Class projects.** With some guidance, students can use AI to build things that used to require significant coding skills: searchable archives, interactive timelines, annotated maps, text analysis projects, even small web applications that present research to real audiences. We work with instructors to design [class projects](/websites/class-projects) where students direct the work, evaluate what AI produces, and take responsibility for the argument.
...
<p class="section-link-bar"><a href="/projects/humanities-for-ai">Why AI work needs humanists →</a></p>
...
**Book a consultation.** If you'd rather talk through your project before diving in, [book a consultation](/collaborate) and we can figure out whether AI fits, how it fits, and what the project might become.
