...
{% include figure.html class="right" width="50%" caption="Globe amaranth flowers retain their color even after drying, embodying their Greek name meaning 'unfading.'" image-path="images/globe-amaranth-dried.jpg" %}
...
{% include figure.html class="right" width="50%" caption="Amaranth grain, cultivated in the Americas for at least 8,000 years, was a dietary staple rivaling corn in importance." image-path="images/amaranth-seeds-bowl.jpg" %}
...
{% include scrollybox/bg-switch.html
  image-path="images/burning-codices.jpg"
  switch-id="switch1"
  bg-id="bg1"
%}
...
{% include scrollybox/bg.html
  height="220"
  image-path="images/amaranth-varieties-collage.jpg"
  pre-box-space="100"
  box-content="With over sixty species, amaranth ranges from sacred grain to superfood to agricultural pest---embodying the contradictions that make humanities inquiry essential."
%}
...
- [Grand Teton Ancient Grains: Amaranth History](https://www.ancientgrains.com/amaranth/amaranth-history-and-origin)
