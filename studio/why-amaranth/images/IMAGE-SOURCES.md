...
### Variety / Contradictions (scrollybox background)
...
1. Cropped to appropriate aspect ratios
2. Optimized using the `scripts/optimize-images.sh` script
3. Color-adjusted for consistency with site design
