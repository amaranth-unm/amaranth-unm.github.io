...
Four templates (Portfolio, Class Project, ScrollStory, and a full-featured version with the complete design system), a CSS design system built on custom properties for easy visual customization, and a library of Liquid includes with documented parameters. Sites work across devices, load quickly, and require nothing beyond a GitHub account to publish.
...
The full Xanthan documentation covers everything from setting up your first site in fifteen minutes to building a scroll-driven narrative with a custom theme. It's designed for people who haven't done this before---and for AI assistants who can do the technical work while you make the decisions.
